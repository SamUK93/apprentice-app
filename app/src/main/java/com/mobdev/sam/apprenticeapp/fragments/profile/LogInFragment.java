...
/**
 * The Log In Fragment. This is essentially the first screen that the user is presented with when
 * they start the app. It allows them to log in using an existing account ID or create a new account
 */
